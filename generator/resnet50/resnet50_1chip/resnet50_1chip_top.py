...
from generator.resnet50.resnet50_1chip.G1_32cores import gen_g1_map_config
from generator.resnet50.resnet50_1chip.G1_IB import gen_g1_ib_map_config
from generator.resnet50.resnet50_1chip.G0_OB import gen_g0_ob_map_config
from generator.resnet50.resnet50_1chip.G2_28cores import gen_g2_map_config
from generator.resnet50.resnet50_1chip.G3_28cores import gen_g3_map_config
from generator.resnet50.resnet50_1chip.G4_28cores import gen_g4_map_config
...
def main():
    ...
    if g1_en:
        g1_config = gen_g1_map_config(phase_en=deepcopy(phase), clock_in_phase=clock_in_phase, size_x=16, size_y=2,
                                      cuts=cuts, static_data=data_all, g1_ib_en=g1_ib_en, g2_en=g2_en, g17_en=g4_en,
                                      g0_en=gbuffer_en, delay_l4=delay_l4_3, delay_l5=delay_l5_3, chip=(0, 0),
                                      init_data=inin_data)
    ...
    if gbuffer_en:
        gbuffer_config = gen_buffer_map_config(phase_en=deepcopy(phase), clock_in_phase=clock_in_phase, size_x=3,
                                               size_y=1, g1_en=g1_en, chip=(0, 0), g0_en=g0_en,
