...
def generate_g10_data(handler, size_y, size_x):
    data = {
        'layer3.1.conv1': {},  # L26
        'layer3.1.relu1': {},
        'layer3.1.cut1': {},
    ...
    l1_input_raw_data = handler.parameters['layer3.1.conv1']['input'].astype(np.int8)
    l1_weight_raw_data = handler.parameters['layer3.1.conv1']['weight'].astype(np.int8)
    l1_bias_raw_data = np.append(handler.parameters['layer3.1.conv1']['bias'].astype(np.int32),
                                 np.zeros_like(handler.parameters['layer3.1.conv1']['bias']).astype(np.int32))
    l1_output_raw_data = handler.parameters['layer3.1.cut1']['output'].astype(np.int8).reshape((256, -1, 1))
    ...
    l2_weight_raw_data = handler.parameters['layer3.1.conv2']['weight'].astype(np.int8)
    l2_bias_raw_data = np.append(handler.parameters['layer3.1.conv2']['bias'].astype(np.int32),
                                 np.zeros_like(handler.parameters['layer3.1.conv2']['bias'], dtype=np.int32))
    l2_output_raw_data = handler.parameters['layer3.1.cut2']['output'].astype(np.int8).reshape((256, -1, 1))
    ...
    l3_input_raw_data = handler.parameters['layer3.1.conv3']['input'].astype(np.int8).reshape(256, 28, 7)
    l3_weight_raw_data = handler.parameters['layer3.1.conv3']['weight'].astype(np.int8)
    l3_bias_raw_data = np.append(handler.parameters['layer3.1.conv3']['bias'].astype(np.int32),
                                 np.zeros_like(handler.parameters['layer3.1.conv3']['bias'], dtype=np.int32))
    l3_output_raw_data = handler.parameters['layer3.1.cut3']['output'].astype(np.int8)
    ...
    y_output_raw_data = handler.parameters['layer3.1.cut5']['output'].astype(np.int8)
