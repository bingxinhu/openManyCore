...
Router_Prim_1.send_destin_core_grp = [
    {"core_id": ((0, 2), (13, 0)), "data_num": 128, "T_mode": 1, "Rhead_num": 1, 'sync_en': 1,
     'sync_phase_num': 0}]
Router_Prim_1.recv_source_core_grp = []
Router_Prim_1.instant_prim_request = []
Router_Prim_1.instant_request_back = []

Router_Prim_1.addRHead(S=0, T=1, P=0, Q=0, X=-4, Y=1, A=0,  # (1,9)
...
test_config = {
    ...
    'debug_file_switch': HardwareDebugFileSwitch().close_all.close_debug_message.singla_chip.dict,
