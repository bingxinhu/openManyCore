...
def prim_tx_core14_0(num):
    ...
    prim_router.send_destin_core_grp = [
        {'core_id': [((0, 0), (0, 0))], 'data_num': 896, 'T_mode': 1, 'Rhead_num': 1, 'sync_en': 1,
         'sync_phase_num': num},
    ]
    ...
    prim_router.addRHead(S=0, T=1, P=0, Q=0, X=-14, Y=0, A=0,
...
def prim_sector1_tx_rx_core(num):
    ...
    prim_router.send_destin_core_grp = [
        {'core_id': [((0, 0), (0, 3))], 'data_num': 896, 'T_mode': 1, 'Rhead_num': 1, 'sync_en': 1,
         'sync_phase_num': num},
    ]
    prim_router.recv_source_core_grp = [
    ...
    prim_soma2.Addr_Start_out = 0x4000+0x700*num  #
...
def prim_core14_0_list_config(i, j):
    ...
    for i in range(4):
        ...
        prim_axon, prim_soma1, prim_router = prim_tx_core14_0(num=i)
...
def prim_core0_0_list_config(i, j):
    ...
    for i in range(4):
        prims_dict = copy.deepcopy(prims_dict)
        prim_axon, prim_soma1, prim_router, prim_soma2 = prim_sector1_tx_rx_core(
            num=i)
        prims_dict['axon'] = prim_axon
        prims_dict['soma1'] = prim_soma1
        prims_dict['router'] = prim_router
...
def prim_core0_3_list_config(i, j):
    ...
    #
    # prims_dict = copy.deepcopy(prims_dict)
    # prim_axon, prim_router, prim_soma2 = prim_rx_core0_3(num=1)
    # prims_dict['axon'] = prim_axon
    # prims_dict['soma1'] = None
    # prims_dict['router'] = prim_router
    # prims_dict['soma2'] = prim_soma2
    ...
    #
    # prims_dict = copy.deepcopy(prims_dict)
    # prim_axon, prim_router, prim_soma2 = prim_rx_core0_3(num=2)
    # prims_dict['axon'] = prim_axon
    # prims_dict['soma1'] = None
    # prims_dict['router'] = prim_router
    # prims_dict['soma2'] = prim_soma2
    ...
    #
    # prims_dict = copy.deepcopy(prims_dict)
    # prim_axon, prim_router, prim_soma2 = prim_rx_core0_3(num=3)
    # prims_dict['axon'] = prim_axon
    # prims_dict['soma1'] = None
    # prims_dict['router'] = prim_router
    # prims_dict['soma2'] = prim_soma2
...
#         config._core_cofig[id]["prims"] = config._core_cofig[id]["prims"][0:3]
test_phase = []
for step_id, group_id, config in MapConfig(map_config):
    phase_num = None
