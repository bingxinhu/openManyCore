...
def check(data, compare: ResultCompare, size_y, size_x, chip=(0, 0), empty_offset=0):
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        ...
        data_1[empty_offset + 0][(chip, (core_x, core_y))] = [{
            'data': data['conv3c1_input1'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x19000 >> 2,
            'type': 1
        }]
        # recv 2/2
        data_1[empty_offset + 1][(chip, (core_x, core_y))] = [{
            'data': data['conv3c1_input2'][(core_x - size_x[0], core_y - size_y[0])],
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        ...
        data_1[empty_offset + offset + 0][chip, (core_x, core_y)] = [{
            'data': data['conv3c1_output_part1'][(core_x - size_x[0], core_y - size_y[0])],
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 1][chip, (core_x, core_y)] = [{
            'data': data['conv3c1_weight1_1'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x0000 >> 2,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        ...
        data_1[empty_offset + offset + 3][chip, (core_x, core_y)] = [{
            'data': data['conv3c1_output_part2'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': addr_start,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        if core_y - size_y[0] == 1:
            data_1[empty_offset + offset + 9][chip, (core_x, core_y)] = [{
                'data': data['conv3c1_output'][(core_x - size_x[0], core_y - size_y[0])],
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        if core_x - size_x[0] + (core_y - size_y[0]) * (size_x[1] - size_x[0]) == 0:
            data_1[empty_offset + offset + 13][chip, (core_x, core_y)] = [{
                'data': data['g7_phase13'][(core_x - size_x[0], core_y - size_y[0])],
                'addr_start': 0xB180 >> 2,
                'type': 1
            }]
        else:
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        if 0 <= core_x - size_x[0] + (core_y - size_y[0]) * (size_x[1] - size_x[0]) <= 6:
            ...
            data_1[empty_offset + offset + 14][chip, (core_x, core_y)] = [{
                'data': data['conv3c2_input0'][(core_x - size_x[0], core_y - size_y[0])],
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        if core_x - size_x[0] + (core_y - size_y[0]) * (size_x[1] - size_x[0]) == 0:
            data_1[empty_offset + offset + 15][chip, (core_x, core_y)] = [{
                'data': data['g7_phase15'][(core_x - size_x[0], core_y - size_y[0])],
                'addr_start': 0xBF80 >> 2,
                'type': 1
            }]
        else:
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        if 0 <= core_x - size_x[0] + (core_y - size_y[0]) * (size_x[1] - size_x[0]) <= 6:
            ...
            data_1[empty_offset + offset + 16][chip, (core_x, core_y)] = [{
                'data': data['conv3c2_input1'][(core_x - size_x[0], core_y - size_y[0])],
                'addr_start': 0xBF80 >> 2,
                'type': 1
            }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 17][chip, (core_x, core_y)] = [{
            'data': data['conv3c2_output'][(core_x - size_x[0], core_y - size_y[0])],
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 18][chip, (core_x, core_y)] = [{
            'data': data['conv3c3_input0'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x8400 >> 2,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 19][chip, (core_x, core_y)] = [{
            'data': data['conv3c3_input1'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x1C800 >> 2,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 20][chip, (core_x, core_y)] = [{
            'data': data['conv3c3_output'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0xBC00 >> 2,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 21][chip, (core_x, core_y)] = [{
            'data': data['conv3c3_output2'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x1C800 >> 2,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 22][chip, (core_x, core_y)] = [{
            'data': data['conv3c3_output3'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x1E400 >> 2,
            'type': 1
        }]
    ...
    for core_y, core_x in product(range(*size_y), range(*size_x)):
        data_1[empty_offset + offset + 23][chip, (core_x, core_y)] = [{
            'data': data['g7_add_output'][(core_x - size_x[0], core_y - size_y[0])],
            'addr_start': 0x1c800 >> 2,
            'type': 1
        }]
...
if __name__ == '__main__':
    ...
    compare = ResultCompare(data_2_file_name='R00007', save_data_1_en=True)
