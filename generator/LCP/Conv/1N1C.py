...
def gen_1N1C_map_config(phase_en, clock_in_phase, size_x, size_y, delay_l4=None, delay_l5=None,
...
if __name__ == '__main__':
    ...
    config = gen_1N1C_map_config(phase, clock_in_phase=clock_in_phase, size_x=1, size_y=1,
