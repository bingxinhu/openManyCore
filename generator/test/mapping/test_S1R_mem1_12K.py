...
Soma_Prim.num_in = 6
Soma_Prim.length_out = 512
Soma_Prim.length_ciso = 0
Soma_Prim.num_out = 6
Soma_Prim.num_ciso = 6
Soma_Prim.type_in = 0
...
Soma_Prim.Addr_Start_in = 0x0000
...
Router_Prim.Send_number = 1535  # 发送的所有包数，包含EN=0的包，需要减1
Router_Prim.Addr_Dout_base = 0x900  # 4B寻址
Router_Prim.Addr_Dout_length = 767  # 16B的个数，需要减1
Router_Prim.Addr_Rhead_base = 0x300  # 4B寻址
Router_Prim.Addr_Rhead_length = 0  # 16B的个数，需要减1
Router_Prim.Addr_Din_base = 0x400  # 4B寻址
Router_Prim.Addr_Din_length = 1535  # 需要减1
