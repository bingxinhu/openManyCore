...
from generator.resnet50.resnet50_2chip.G1_check import check as g1_check
from generator.resnet50.resnet50_2chip.G1_ib_check import check as g1_ib_check
from generator.resnet50.resnet50_2chip.G0_OB_check import check as g0_ob_check
from generator.resnet50.resnet50_2chip.G2_check import check as g2_check
from generator.resnet50.resnet50_2chip.G3_check import check as g3_check
from generator.resnet50.resnet50_2chip.G4_check import check as g4_check
from generator.resnet50.resnet50_2chip.G5_check import check as g5_check
from generator.resnet50.resnet50_2chip.GBuffer_check import check as gb_check
...
if g5_en:
    g5_check(data=data_all, compare=compare, size_y=(0, 2), size_x=(0, 16), chip=(0, 1), empty_offset=empty_offset)

if gb_en:
    gb_check(data=data_all, compare=compare, empty_offset=empty_offset)
