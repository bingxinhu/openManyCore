...
def Gen_G9_instant(start_instant_PI_num = 0):
    init = True
    map_config = {
        'sim_clock': 30000,
        0: {
    ...
    for core_x in range(M):
        for core_y in range(2):
            if core_x == 0 and core_y == 0:
                ...
                map_config[0][0][(chip, (core_x, core_y))]['prims'].append({'axon': None, 'soma1': None, 'router': None, 'soma2': None})
                map_config[0][0][(chip, (core_x, core_y))]['instant_prims'] = []
                map_config[0][0][(chip, (core_x, core_y))]['instant_prims'].append({'axon': None, 'soma1': None, 'router': Router_Prim_1, 'soma2': None})
                ...
                map_config[0][0][(chip, (core_x, core_y))]['prims'].append({'axon': None, 'soma1': None, 'router': None, 'soma2': None})
                map_config[0][0][(chip, (core_x, core_y))]['instant_prims'] = []
                map_config[0][0][(chip, (core_x, core_y))]['instant_prims'].append({'axon': None, 'soma1': None, 'router': Router_Prim_2, 'soma2': None})
                map_config[0][0][(chip, (core_x, core_y))]['registers'] = {
                    "Receive_PI_addr_base": 0x350 >> 2,
                    "PI_CXY": 0,
                    "PI_Nx": 0,
    ...
    for core_x in range(N):
        for core_y in range(2, 2 + P):
            ...
            if core_x == 0 and core_y == 2:
                ...
                map_config[0][1][(chip, (core_x, core_y))]['prims'] = [{'axon': None, 'soma1': None, 'router': Router_Prim_3, 'soma2': soma2}]
                #map_config[0][1][(chip, (core_x, core_y))]['instant_prims'].append({'axon': None, 'soma1': None, 'router': Router_Prim_3, 'soma2': soma2})
                ...
                map_config[0][1][(chip, (core_x, core_y))] = {}
                map_config[0][1][(chip, (core_x, core_y))]['prims'] = [{'axon': None, 'soma1': None, 'router': Router_Prim_5, 'soma2': soma2}]
                # map_config[0][1][(chip, (core_x, core_y))]['instant_prims'] = []
                # map_config[0][1][(chip, (core_x, core_y))]['instant_prims'].append({'axon': None, 'soma1': None, 'router': Router_Prim_5, 'soma2': soma2})
                map_config[0][1][(chip, (core_x, core_y))]['registers'] = {
                    "Receive_PI_addr_base": 0,
                     "PI_CXY": 0,
                     "PI_Nx": 0,
