...
def gen_3_map_config(phase_en, clock_in_phase, size_x, size_y, in_cut_start_dict=None, data=None,
    ...
    if phase_en[offset + 0]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=0x10000 >> 2, addr_bias=0x10480 >> 2,
    ...
    if phase_en[offset + 1]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80) >> 2, addr_bias=0x0,
    ...
    if phase_en[offset + 2]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p02(avg_pooling_en=False, ina_type=0, load_bias=0, kx=1, ky=2, sx=1, sy=1, cin=128, 
                       px=56, py=1, addr_in=0x0000 >> 2, addr_bias=0x0, addr_out=0x0000 >> 2, pad_top=0, pad_down=0, pad_left=0,
    ...
    if phase_en[offset + 3]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 2) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 5]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 3) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 7]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 4) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 9]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 5) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 11]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 6) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 13]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 7) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 15]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=1, tensor_sx=1, tensor_sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=(0x10000 + 0x80 * 8) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 17]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p41(px=56, py=1, cin=128, cout=128, kx=1, ky=1, sx=1, sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=0x10680 >> 2, addr_bias=0x14680 >> 2, addr_out=0x0000 >> 2, 
...
if __name__ == '__main__':
    ...
    config = gen_3_map_config(phase, clock_in_phase=clock_in_phase, size_x=14, size_y=4,
