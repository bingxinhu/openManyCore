...
def gen_6_map_config(phase_en, clock_in_phase, size_x, size_y, in_cut_start_dict=None, data=None,
    ...
    if phase_en[offset + 0]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=0xF300 >> 2, addr_bias=0xFC00 >> 2,
                       addr_out=0x3800 >> 2, ina_type=1, inb_type=1, load_bias=2, bias_length=256, inb_length=256,
    ...
    if phase_en[offset + 1]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
    ...
    if phase_en[offset + 2]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p02(avg_pooling_en=False, ina_type=0, load_bias=0, kx=1, ky=2, sx=1, sy=1, cin=256, 
                       px=7, py=2, addr_in=0x3800 >> 2, addr_bias=0x0, addr_out=0x3800 >> 2, pad_top=0, pad_down=0, pad_left=0,
    ...
    if phase_en[offset + 3]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 2) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 5]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 3) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 7]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 4) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 9]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 5) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 11]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 6) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 13]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 7) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 15]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=14, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x0000 >> 2, addr_inb=(0xF300 + 0x100 * 8) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=256, inb_length=256,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 16]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p02(avg_pooling_en=False, ina_type=0, load_bias=0, kx=1, ky=2, sx=1, sy=1, cin=256, 
                       px=7, py=2, addr_in=0x3800 >> 2, addr_bias=0x0, addr_out=0x3800 >> 2, pad_top=0, pad_down=0, pad_left=0,
                       pad_right=0, bias_length=0, data_x=None, data_b=None, constant_b=0)
            soma1 = pX5(mode='max', addr_in=0x3800 >> 2, addr_out=0xA800 >> 2,
                        cin=256, cout=256, px=7, py=2,
    ...
    if phase_en[offset + 17]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = None
            soma1 = pX5(mode='max', addr_in=0xA800 >> 2, addr_out=0x24000 >> 2,
                        cin=256, cout=256, px=7, py=2,
            ...
            router = p09(rhead_mode=1, send_en=True, receive_en=True, 
                         send_num=2 * 7 * 256 // 8 - 1, receive_num=0,
                         addr_din_base=0x1000 >> 2, addr_din_length=2 * 7 * 256 // 8 - 1, addr_rhead_base=addr_rhead_base,
                         addr_rhead_length=0, addr_dout_base=0x4000 >> 2, addr_dout_length=0, soma_in_en=1,
                         cxy=0, relay_num=0, nx=0, ny=0, data_in=None)
            router.addRHead(S=0, T=1, P=0, Q=0, X=1 if core_x % 2 == 0 else -1, Y=0, A=0, pack_per_Rhead=2 * 7 * 256 // 8 - 1,
                            A_offset=0, Const=0, EN=1)
            soma2 = p06(addr_in=0xA800 >> 2 if core_x % 2 == 0 else 0x21000 >> 2, 
                        addr_out=0x0000 >> 2, addr_ciso=0x21000 >> 2 if core_x % 2 == 0 else 0xA800 >> 2, 
                        length_in=7 * 256, num_in=2, length_ciso=7 * 256, num_ciso=2, length_out=14 * 256, num_out=2, 
    ...
    if phase_en[offset + 18]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p41(px=14, py=2, cin=256, cout=256, kx=1, ky=1, sx=1, sy=1,
                       addr_ina=0x0000 >> 2, addr_inb=0x10000 >> 2, addr_bias=0xEF00 >> 2, addr_out=0x3800 >> 2, 
                       pad_top=0, pad_down=0, pad_left=0, pad_right=0,
                       ina_type=1, inb_type=1, load_bias=2, data_x=None, data_w=[], data_b=[])
            soma1 = pX5(mode='max', addr_in=0x3800 >> 2, addr_out=0x7000 >> 2,
...
if __name__ == '__main__':
    ...
    config = gen_6_map_config(phase, clock_in_phase=clock_in_phase, size_x=14, size_y=1,
