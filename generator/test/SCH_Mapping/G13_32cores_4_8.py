...
def Gen_G13_Map_Config(phase_en, clock, M, N, start_row=0, in_data_en=0, out_data_en=0, delay_L4=(), delay_L5=()):
    """
    ResNet-50 Group13 Mapping
    ...
    if phase_en[0] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         ...
                         addr_din_base=0x380, addr_din_length=319, receive_num=1, t_mode=1, soma_in_en=0)
            if in_data_en == 1:
                router.Receive_en = 1
            ...
            if out_data_en == 1:
                ...
                if core_y == 0:
                    ...
                    dst_y = 0
                A = core_x * 4
                router.addRHead(S=0, T=1, P=0, Q=1, X=dst_x - core_x, Y=0, A=A,
    ...
    if phase_en[3] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         ...
                         addr_din_base=0x380, addr_din_length=639, receive_num=1, t_mode=1, soma_in_en=0)
            if in_data_en == 1:
                router.Receive_en = 1
                if core_y - start_row == 0:
                    if core_x != 7:
    ...
    if phase_en[4] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         ...
                         addr_din_base=0x380, addr_din_length=1599, receive_num=1, t_mode=1, soma_in_en=0)
            if in_data_en == 1:
                router.Receive_en = 1
                if core_y - start_row == 0:
                    if core_x != 7:
    ...
    if phase_en[5] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         ...
                         addr_din_base=0x380, addr_din_length=1535, receive_num=1, t_mode=1, soma_in_en=0)
            if in_data_en == 1:
                router.Receive_en = 1
                if core_y - start_row == 0:
                    if core_x != 7:
...
#
# map_config = Gen_G13_Map_Config(phase_en, 28000, M=8 , N=4)
#
