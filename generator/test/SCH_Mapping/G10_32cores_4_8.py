...
def Gen_G10_Map_Config(phase_en, clock, M, N, start_row=0, in_data_en=0, out_data_en=0, delay_L4=(), delay_L5=()):
    """
    ResNet-50 Group10 Mapping
    ...
    if phase_en[0] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         addr_dout_length=0, send_num=39, addr_rhead_base=0x300, addr_rhead_length=0, cxy=0, \
    ...
    if phase_en[3] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            if in_data_en == 1:
                soma2 = pX5(core_x=core_x, core_y=core_y, PIC_mode=0, pad_on=False, type_in=1, type_out=1, cin=256, \
                            cout=256, px=20, py=1, kx=1, ky=1, sx=1, sy=1, cmp_c=0x80808080,\
...
#
# map_config = Gen_G10_Map_Config(phase_en, 28000, M=8 , N=4)
#
