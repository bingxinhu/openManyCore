...
def gen_4_map_config(phase_en, clock_in_phase, size_x, size_y, in_cut_start_dict=None, data=None,
    ...
    if phase_en[offset + 0]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=0x10000 >> 2, addr_bias=0x10480 >> 2,
    ...
    if phase_en[offset + 1]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80) >> 2, addr_bias=0x0,
    ...
    if phase_en[offset + 3]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 2) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 5]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 3) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 7]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 4) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 9]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 5) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 11]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 6) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 13]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 7) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 15]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p43(tensor_en=True, x_array_num=0, tensor_px=56, tensor_py=4, tensor_sx=2, tensor_sy=2,
                       addr_ina=0x18A80 >> 2, addr_inb=(0x10000 + 0x80 * 8) >> 2, addr_bias=0x0,
                       addr_out=0x7000 >> 2, ina_type=1, inb_type=1, load_bias=0, bias_length=128, inb_length=128,
                       data_x=None, data_a=[], data_b=None)
            soma1 = None
            router = None
    ...
    if phase_en[offset + 17]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p41(px=28, py=2, cin=128, cout=256, kx=1, ky=1, sx=1, sy=1,
                       addr_ina=0xE000 >> 2, addr_inb=0x10680 >> 2, addr_bias=0x18680 >> 2, addr_out=0x0000 >> 2, 
...
if __name__ == '__main__':
    ...
    clock_in_phase = 25_000
    config = gen_4_map_config(phase, clock_in_phase=clock_in_phase, size_x=14, size_y=1,
