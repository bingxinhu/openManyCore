...
def main():
    ...
    ctime = '' if debug else '_' + time.strftime("%Y-%m-%d_%H-%M-%S", time.localtime())
    case_file_name = 'SJTL_106' + ctime
    ...
    delay_l4 = (97,) * 9        # 97 -- 延时数量： 0x16dca * 4
    delay_l5 = (97,) * 9
    send_to_fpga = True
    ...
    # config.map_config[((0, 0), 1)][1] = config.map_config[((0, 0), 1)].pop(0)
