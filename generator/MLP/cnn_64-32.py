...
def gen_map_config(phase_en, clock_in_phase, size_x, size_y, delay_l4=None, delay_l5=None,
    ...
    if phase_en[0]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p41(px=16, py=16, cin=32, cout=32, kx=3, ky=3, sx=1, sy=1,
                       addr_ina=0x9000 >> 2, addr_inb=0x10000 >> 2, addr_bias=0x0 >> 2,
                       addr_out=0x0000 >> 2, ina_type=1, inb_type=3,
                       load_bias=0, pad_top=1, pad_down=1, pad_left=1, pad_right=1,
...
if __name__ == '__main__':
    ...
    case_file_name = 'CNN_32_32_160cores'
    chip = (0, 0)
    ...
    clock_in_step_0 = 19999
    clock_in_step_1 = 20000
    ...
    config['sim_clock'] = clock_in_step_1 * 2
