...
def gen_g1_map_config(phase_en, clock_in_phase, size_x, size_y, cuts, static_data=None,
                      g1_ib_en=False, g2_en=False, delay_l4=None, delay_l5=None, chip=(0, 0), init_data=True):
    """
        ...
        for core_y, core_x in product(range(size_y), range(size_x)):
            ...
            if g2_en:
                soma1 = p06(addr_in=addr_in, addr_out=0x9000, addr_ciso=0x0000 >> 2, length_in=length_in * 4,
                            ...
                            data_in=static_data['maxpool1a2_output'][(core_x, core_y)] if init_data else None)
            recv_num = 0
            ...
            router = p09(rhead_mode=1, send_en=g2_en, receive_en=g1_ib_en,
