...
def test_case():
    ...
    axon41_conv2.InB_type = 1
    axon41_conv2.Load_Bias = 0
    axon41_conv2.cin = 6
    axon41_conv2.cout = 32
    ...
    test_config = {
        ...
        'debug_file_switch': HardwareDebugFileSwitch().dict,
