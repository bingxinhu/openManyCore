...
def read_ir(name: str):
    config = None
    with open("temp/mapping_ir/mchip2/"+name, "rb") as f:
...
def mapping():
    ...
    xmk_snn_2core = read_ir("IR_snn2c.xmk")
    map_config[((0, 0), 0)] = {}
    map_config[((0, 0), 0)][0] = xmk_snn_2core[0][0]
    ...
    # 9-13  2,1
    # 14-16 2,0
    sch = read_ir("sch_0718_phaseAll_0847.map_config")
    # map_config=sch
    for i in range(7):
