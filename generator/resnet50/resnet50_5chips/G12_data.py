...
def generate_g12_data(handler, size_y, size_x):
    data = {
        'layer3.3.conv1': {},  # L26
        'layer3.3.relu1': {},
        'layer3.3.cut1': {},
    ...
    l1_input_raw_data = handler.parameters['layer3.3.conv1']['input'].astype(np.int8)
    l1_weight_raw_data = handler.parameters['layer3.3.conv1']['weight'].astype(np.int8)
    l1_bias_raw_data = np.append(handler.parameters['layer3.3.conv1']['bias'].astype(np.int32),
                                 np.zeros_like(handler.parameters['layer3.3.conv1']['bias']).astype(np.int32))
    l1_output_raw_data = handler.parameters['layer3.3.cut1']['output'].astype(np.int8).reshape((256, -1, 1))
    ...
    l2_weight_raw_data = handler.parameters['layer3.3.conv2']['weight'].astype(np.int8)
    l2_bias_raw_data = np.append(handler.parameters['layer3.3.conv2']['bias'].astype(np.int32),
                                 np.zeros_like(handler.parameters['layer3.3.conv2']['bias'], dtype=np.int32))
    l2_output_raw_data = handler.parameters['layer3.3.cut2']['output'].astype(np.int8).reshape((256, -1, 1))
    ...
    l3_input_raw_data = handler.parameters['layer3.3.conv3']['input'].astype(np.int8).reshape(256, 28, 7)
    l3_weight_raw_data = handler.parameters['layer3.3.conv3']['weight'].astype(np.int8)
    l3_bias_raw_data = np.append(handler.parameters['layer3.3.conv3']['bias'].astype(np.int32),
                                 np.zeros_like(handler.parameters['layer3.3.conv3']['bias'], dtype=np.int32))
    l3_output_raw_data = handler.parameters['layer3.3.cut3']['output'].astype(np.int8)
    ...
    y_output_split_dict, y_output_split_dict1, y_output_split_dict2 = {}, {}, {}
    y_output_split_dict3, y_output_split_dict4 = {}, {}
    y_output_raw_data = handler.parameters['layer3.3.cut5']['output'].astype(np.int8)
    ...
    for core_x, core_y in [(12, 0), (13, 0), (14, 0), (15, 0), (12, 1), (13, 1), (14, 1), (15, 1)]:
        y_output_split_dict3[(core_x, core_y)] = (((core_x - 12) * 256, (core_x - 12 + 1) * 256),
                                                  ((1 - core_y) * 14, (1 - core_y) * 14 + 7),
                                                  (0, 7))
        y_output_split_dict4[(core_x, core_y)] = (((core_x - 12) * 256, (core_x - 12 + 1) * 256),
                                                  ((1 - core_y) * 14 + 7, (1 - core_y) * 14 + 14),
                                                  (0, 7))
    data['layer3.3.cut5']['output'] = ResNetDataHandler.tensor_split(
        raw_data=y_output_raw_data, split_dict=y_output_split_dict, data_type=1, alignment=(16, None, None),
        dims=(0, 2, 1))
    data['layer3.3.cut5']['output1'] = ResNetDataHandler.tensor_split(
        raw_data=y_output_raw_data.reshape((1024, 28, 7)), split_dict=y_output_split_dict1, data_type=1,
        alignment=(16, None, None), dims=(0, 2, 1))
    data['layer3.3.cut5']['output2'] = ResNetDataHandler.tensor_split(
        raw_data=y_output_raw_data.reshape((1024, 28, 7)), split_dict=y_output_split_dict2, data_type=1,
        alignment=(16, None, None), dims=(0, 2, 1))
    data['layer3.3.cut5']['output3'] = ResNetDataHandler.tensor_split(
        raw_data=y_output_raw_data.reshape((1024, 28, 7)), split_dict=y_output_split_dict3, data_type=1,
        alignment=(16, None, None), dims=(0, 2, 1))
    data['layer3.3.cut5']['output4'] = ResNetDataHandler.tensor_split(
        raw_data=y_output_raw_data.reshape((1024, 28, 7)), split_dict=y_output_split_dict4, data_type=1,
        alignment=(16, None, None), dims=(0, 2, 1))
