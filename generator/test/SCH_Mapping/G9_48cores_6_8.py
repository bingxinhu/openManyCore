...
from generator.test.SCH_Mapping.G9_16cores_2_8 import Gen_G9_shortcut_Map_Config
...
def Gen_G9_Map_Config(phase_en, clock, M, N, start_row=0, in_data_en=0, out_data_en=0, delay_L4=(0, 0, 0, 0, 0, 0), delay_L5=(0, 0, 0, 0, 0, 0)):
    ...
    if phase_en[25] == 1:
        ...
        for core in range(start_row * M, start_row * M + core_num):
            ...
            map_config[0][0][((0, 0), (core_x, core_y))]['router'].append(Router_Prim_3)
    ...
    for i in range(0, 8):
        for j in range(0, 2):
            final_map_config[0][0][((0, 0), (i, j))] = shortcut_map_config[0][0][((0, 0), (i - 0, j - 0))]
        for j in range(2, 6):
...
if run:
    ...
    # map_config = change_ir_to_prims(map_config=map_config, group_idx_list=[0,1], chip_x_num=1, chip_y_num=1, core_x_num=16, core_y_num=10)
