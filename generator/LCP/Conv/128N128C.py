...
def gen_128N128C_map_config(phase_en, clock_in_phase, size_x, size_y, delay_l4=None, delay_l5=None,
    ...
    if phase_en[offset + 0]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p41(px=32, py=32, cin=16, cout=32, kx=1, ky=1, sx=1, sy=1,
    ...
    if phase_en[offset + 1]:
        for core_y, core_x in product(range(size_y), range(size_x)):
            axon = p41(px=32, py=32, cin=32, cout=32, kx=1, ky=1, sx=1, sy=1,
...
if __name__ == '__main__':
    ...
    config = gen_128N128C_map_config(phase, clock_in_phase=clock_in_phase, size_x=16, size_y=8,
