...
from generator.sound_tracking.GRU import GRUCell
...
class SoundTrackingDataHandler(DataHandler):
    def __init__(self, input_channels, output_channels, hidden_size, sequence_length=39, seed=5):
        ...
        state_dict = torch.load('generator/sound_tracking/quantized_sound_tracking_75.49219280380177.pth', map_location=device)
