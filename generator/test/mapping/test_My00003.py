...
Router_Prim_1.add_instant_pi(
    PI_addr_offset=0, A_valid=0, S1_valid=0, R_valid=1, S2_valid=0, X=1, Y=0, Q=1)

Router_Prim_1.addRHead(S=0, T=1, P=0, Q=0, X=1, Y=0, A=0,
                       pack_per_Rhead=111, A_offset=0, Const=0, EN=1)
Router_Prim_1.addRHead(S=0, T=1, P=0, Q=0, X=1, Y=1, A=112,
                       pack_per_Rhead=111, A_offset=0, Const=0, EN=1)
...
Router_Prim3.instant_request_back = [((0, 0), (0, 0))]
...
Router_Prim.Addr_Din_length = 223
...
map_config = {
    ...
    0: {
        ...
        1: {'clock': 20000,
            'mode': 1,
            ((0, 0), (1, 0)): {
                'prims': [{'axon': None, 'soma1': prim_soma1, 'router': None, 'soma2': None}],
