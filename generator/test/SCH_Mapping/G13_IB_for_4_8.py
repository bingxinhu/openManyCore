...
def Gen_G13_IB(phase_en, clock,start_row=0, in_data_en=0, out_data_en=0, delay_L4=(), delay_L5=()):
    """
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=5, num_ciso=5, num_out=5, row_ck_on=0, addr_in=0x10000 >> 2,
                            addr_ciso=0x1c100 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         ...
                         addr_din_base=0x380, addr_din_length=223, receive_num=0, t_mode=1, soma_in_en=0)
            if out_data_en == 1:
                router.Send_en = 1
                router.Soma_in_en = 1
                if (core_x, core_y) in [(4, 9), (5, 9)]:
                    dst_x = 8
                    dst_y = 8
                    if (core_x, core_y) == (5, 9):
                        A = router.Send_number + 1
                    else:
                        A = 0
                elif (core_x, core_y) in [(6, 9), (7, 9)]:
                    dst_x = 9
                    dst_y = 7
                    if (core_x, core_y) == (7, 9):
                        A = router.Send_number + 1
                    else:
                        A = 0
                elif (core_x, core_y) in [(8, 9), (9, 9)]:
                    dst_x = 10
                    dst_y = 6
                    if (core_x, core_y) == (9, 9):
                        A = router.Send_number + 1
                    else:
                        A = 0
                elif (core_x, core_y) in [(10, 9), (11, 9)]:
                    dst_x = 11
                    dst_y = 5
                    if (core_x, core_y) == (11, 9):
                        A = router.Send_number + 1
                    else:
                        A = 0
            ...
            if in_data_en == 1:
                soma2 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=7, num_ciso=7, num_out=7, row_ck_on=0, addr_in=0x8380,
                            addr_ciso= 0x0>> 2,
                            addr_out=0x16200 >> 2)
            else:
                soma2 = None
    ...
    if phase_en[1] == 1:
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=5, num_ciso=5, num_out=5, row_ck_on=0, addr_in=0x10000+5*256 >> 2,
                            addr_ciso=0x1c100 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
    ...
    if phase_en[2] == 1:
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=5, num_ciso=5, num_out=5, row_ck_on=0, addr_in=0x10000+10*256 >> 2,
                            addr_ciso=0x1c100 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
    ...
    if phase_en[3] == 1:
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=10, num_ciso=10, num_out=10, row_ck_on=0, addr_in=0x10000+15*256 >> 2,
                            addr_ciso=0x1c100 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         ...
                         addr_din_base=0x380, addr_din_length=479, receive_num=0, t_mode=1, soma_in_en=0)
            if out_data_en == 1:
                router.Send_en = 1
                router.Soma_in_en = 1
                if (core_x, core_y) in [(4, 9), (5, 9)]:
            ...
            if in_data_en == 1:
                soma2 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=15, num_ciso=15, num_out=15, row_ck_on=0, addr_in=0x8380,
                            addr_ciso= 0x0>> 2,
                            addr_out=0x16200+21*256 >> 2)
            else:
                soma2 = None
            map_config[0][0][((0, 0), (core_x, core_y))]['soma2'].append(soma2)
    ...
    if phase_en[4] == 1:
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=25, num_ciso=25, num_out=25, row_ck_on=0, addr_in=0x11900 >> 2,
                            addr_ciso=0x0 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
                ...
                if map_config[0][0][((0, 0), (core_x, core_y))]['router'][temp_phase - 1] != None:
                    ...
                    if map_config[0][0][((0, 0), (core_x, core_y))]['router'][temp_phase - 1].Send_en == 1:
                        rhead_base += (map_config[0][0][((0, 0), (core_x, core_y))]['router'][
                                           temp_phase - 1].Addr_Rhead_length + 1) * 4
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         addr_dout_length=0, send_num=799, addr_rhead_base=rhead_base, addr_rhead_length=0, cxy=0, \
            ...
            if in_data_en == 1:
                soma2 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=20, num_ciso=20, num_out=20, row_ck_on=0, addr_in=0x8380,
                            addr_ciso=0x0,
                            addr_out=(0x16200 + 36*256) >> 2)
            else:
                soma2 = None
            map_config[0][0][((0, 0), (core_x, core_y))]['soma2'].append(soma2)
    ...
    if phase_en[5] == 1:
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=24, num_ciso=24, num_out=24, row_ck_on=0, addr_in=0x13200 >> 2,
                            addr_ciso=0x0 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
                ...
                if map_config[0][0][((0, 0), (core_x, core_y))]['router'][temp_phase - 1] != None:
                    ...
                    if map_config[0][0][((0, 0), (core_x, core_y))]['router'][temp_phase - 1].Send_en == 1:
                        rhead_base += (map_config[0][0][((0, 0), (core_x, core_y))]['router'][
                                           temp_phase - 1].Addr_Rhead_length + 1) * 4
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         addr_dout_length=0, send_num=767, addr_rhead_base=rhead_base, addr_rhead_length=0, cxy=0, \
                         addr_din_base=0x380, addr_din_length=639, receive_num=0, t_mode=1, soma_in_en=0)
            if out_data_en == 1:
                router.Send_en = 1
                router.Soma_in_en = 1
    ...
    if phase_en[6] == 1:
        ...
        for (core_x, core_y) in [(4, 9), (5, 9), (6, 9), (7, 9), (8, 9), (9, 9), (10, 9), (11, 9)]:
            ...
            if out_data_en == 1:
                soma1 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=24, num_ciso=24, num_out=24, row_ck_on=0, addr_in=0x14a00 >> 2,
                            addr_ciso=0x0 >> 2,
                            addr_out=0x9000)
                s1 = soma1.init_data()
                soma1.memory_blocks = [
            ...
            router = p09(core_x=core_x, core_y=core_y, rhead_mode=1, send_en=0, receive_en=0, addr_dout_base=0x1000, \
                         addr_dout_length=0, send_num=767, addr_rhead_base=rhead_base, addr_rhead_length=0, cxy=0, \
                         addr_din_base=0x380, addr_din_length=703, receive_num=0, t_mode=1, soma_in_en=0)
            if out_data_en == 1:
                router.Send_en = 1
                router.Soma_in_en = 1
                if (core_x, core_y) in [(4, 9), (5, 9)]:
            ...
            if in_data_en == 1:
                router.Receive_en = 1
                router.Addr_Din_length = 703
            map_config[0][0][((0, 0), (core_x, core_y))]['router'].append(router)

            if in_data_en == 1:
                soma2 = pX6(core_x=core_x, core_y=core_y, type=6, length_in=256, length_ciso=16,
                            length_out=256, \
                            num_in=22, num_ciso=22, num_out=22, row_ck_on=0, addr_in=0x8380,
                            addr_ciso=0x0,
                            addr_out=(0x16200 + 76 * 256) >> 2)
            else:
                soma2 = None
            map_config[0][0][((0, 0), (core_x, core_y))]['soma2'].append(soma2)
