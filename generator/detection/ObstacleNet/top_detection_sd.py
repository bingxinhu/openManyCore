...
def main(mouse_en=0, send_to_fpga=True):
    ...
    count = MapConfigGen.conut_prim_number(config.map_config)
    count_rhead = MapConfigGen.get_max_router_rhead_base(config.map_config)
...
if __name__ == '__main__':
    ...
    map_config['step_clock'][((0, 0), 0)] = (clock_0, clock_1)
    map_config['step_clock'][((0, 0), 1)] = (clock_0, clock_1)
    map_config['step_clock'][((0, 0), 2)] = (clock_0, clock_1)
    map_config['step_clock'][((0, 0), 3)] = (clock_0, clock_1)

    # det_map[((0, 0), 0)] = st_map.pop(((0, 0), 0))
