...
class GRUCell(nn.Module):
    ...
    def forward(self, x, hid):
        ...
        r = (torch.floor(self.lut_list['sigmoid_r_m'] * torch.sigmoid(GRU3_cut / self.lut_list['sigmoid_r_d']))).clamp(-128, 127)
        ...
        z = (torch.floor(self.lut_list['sigmoid_z_m'] * torch.sigmoid(GRU6_cut / self.lut_list['sigmoid_z_d']))).clamp(-128, 127)
